...
in
{
  ...
  initrd = makeTest {
    ...
    testScript = ''
      ...
      bootspec = json.loads(machine.succeed("jq -r '.\"org.nixos.bootspec.v1\"' /run/current-system/bootspec/boot.json"))
  ...
  specialisation = makeTest {
    ...
    testScript = ''
      ...
      assert sp_in_parent == sp_in_fs['org.nixos.bootspec.v1'], "Bootspecs of the same specialisation are different!"
    '';
  };
