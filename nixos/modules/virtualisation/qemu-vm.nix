...

{
  ...
  options = {
    ...
    virtualisation.bootDevice =
      mkOption {
        ...
        default = if cfg.diskImage != null then lookupDriveDeviceName "root" cfg.qemu.drives else null;
  ...
  config = {
    ...
    boot.initrd.postDeviceCommands = lib.mkIf (cfg.diskImage != null && cfg.useDefaultFilesystems && !config.boot.initrd.systemd.enable)
      ''
